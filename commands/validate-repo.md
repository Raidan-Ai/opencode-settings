...
1. List all files in `/home/ecs-user/.config/opencode/context/`
...
1. **Orphaned Context File**
   - File: `/home/ecs-user/.config/opencode/context/legacy/old-patterns.md`
...
1. **Missing Context File**
   ...
   - Expected path: `/home/ecs-user/.config/opencode/context/core/advanced-patterns.md`
...
1. Create missing file: `/home/ecs-user/.config/opencode/context/core/advanced-patterns.md`
