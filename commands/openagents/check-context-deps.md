...
<workflow id="analyze_context_dependencies">
  <stage id="1" name="ScanAgents" required="true">
    ...
    **Search patterns**:
    - `/home/ecs-user/.config/opencode/context/` (direct path references)
    - `@/home/ecs-user/.config/opencode/context/` (@ symbol references)
  ...
  <stage id="3" name="ValidateContextFiles" required="true">
    ...
    **Check existence**:
    ```bash
    test -f /home/ecs-user/.config/opencode/context/core/standards/code-quality.md
    ```
  ...
  <stage id="4" name="Report" required="true">
    ...
    **Uses but not declared**:
    - context:core/standards/code (referenced 3 times)
      - Line 64: "Code tasks → /home/ecs-user/.config/opencode/context/core/standards/code-quality.md (MANDATORY)"
      - Line 170: "Read /home/ecs-user/.config/opencode/context/core/standards/code-quality.md NOW"
...
```bash
grep -rn "\/home/ecs-user/.config/opencode/context/" .opencode/agent/ .opencode/command/
```
...
- `/home/ecs-user/.config/opencode/context/core/standards/code-quality.md` → `context:core/standards/code`
- `@/home/ecs-user/.config/opencode/context/openagents-repo/quick-start.md` → `context:openagents-repo/quick-start`
...
task(
  ...
  prompt=`
    ...
    2. Search for these patterns:
       - "/home/ecs-user/.config/opencode/context/core/" (direct paths)
       - "@/home/ecs-user/.config/opencode/context/" (@ references)
    ...
    4. For each context file in /home/ecs-user/.config/opencode/context/core/:
...
✓ /home/ecs-user/.config/opencode/context/core/context-system.md (1 reference)
  - Line 15: "Load: context:core/context-system"
✓ /home/ecs-user/.config/opencode/context/core/context-system/standards/mvi.md (2 references)
...
- **Context guide**: `/home/ecs-user/.config/opencode/context/openagents-repo/quality/registry-dependencies.md`
