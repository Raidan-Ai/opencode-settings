...
- Code tasks → /home/ecs-user/.config/opencode/context/core/standards/code-quality.md (MANDATORY)
```
...
**Path normalization**:
```
File path:     /home/ecs-user/.config/opencode/context/core/standards/code-quality.md
...
```
dependencies:
  - context:core/standards/code           # /home/ecs-user/.config/opencode/context/core/standards/code-quality.md
  - context:core/standards/docs           # /home/ecs-user/.config/opencode/context/core/standards/documentation.md
  - context:core/workflows/delegation     # /home/ecs-user/.config/opencode/context/core/workflows/task-delegation-basics.md
...
- context:core/standards/code (referenced 3 times)
  - Line 64: "Code tasks → /home/ecs-user/.config/opencode/context/core/standards/code-quality.md"
...
```bash
# Make your changes
vim /home/ecs-user/.config/opencode/context/core/standards/code-quality.md
```
...
ls -la /home/ecs-user/.config/opencode/context/core/standards/code-quality.md
...
rm /home/ecs-user/.config/opencode/context/core/standards/code-analysis.md
./scripts/registry/auto-detect-components.sh --auto-add
```
...
- **Registry Guide**: `/home/ecs-user/.config/opencode/context/openagents-repo/guides/updating-registry.md`
- **Registry Concepts**: `/home/ecs-user/.config/opencode/context/openagents-repo/core-concepts/registry.md`
- **Adding Agents**: `/home/ecs-user/.config/opencode/context/openagents-repo/guides/adding-agent-basics.md`
