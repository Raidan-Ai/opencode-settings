...
glob(pattern="**/*.md", path="/home/ecs-user/.config/opencode/context")

// 2. Use grep to search content
grep(pattern="registry", path="/home/ecs-user/.config/opencode/context")

// 3. Read relevant files directly
read(filePath="/home/ecs-user/.config/opencode/context/openagents-repo/core-concepts/registry.md")
```
