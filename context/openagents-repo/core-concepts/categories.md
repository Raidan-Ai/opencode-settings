...
/home/ecs-user/.config/opencode/context/development/
├── navigation.md
├── clean-code.md
├── react-patterns.md
└── api-design.md
...
mkdir -p /home/ecs-user/.config/opencode/context/{category}
...
```bash
cat > /home/ecs-user/.config/opencode/context/{category}/navigation.md << 'EOF'
...
```
/home/ecs-user/.config/opencode/context/{category}/
...
Loads: `/home/ecs-user/.config/opencode/context/ui/web/react-patterns.md`
