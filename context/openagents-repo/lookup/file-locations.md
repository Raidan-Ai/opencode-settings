...
| **Context files** | `/home/ecs-user/.config/opencode/context/` |
...
| **New context** | `/home/ecs-user/.config/opencode/context/{category}/{name}.md` |
...
```
/home/ecs-user/.config/opencode/context/{category}/{topic}.md
```

**Examples**:
- `/home/ecs-user/.config/opencode/context/core/standards/code-quality.md`
- `/home/ecs-user/.config/opencode/context/ui/web/react-patterns.md`
- `/home/ecs-user/.config/opencode/context/content-creation/principles/copywriting-frameworks.md`
...
```bash
# By category
ls /home/ecs-user/.config/opencode/context/{category}/

# All context
find /home/ecs-user/.config/opencode/context -name "*.md"
```
