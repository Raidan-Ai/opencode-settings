...
**Purpose**: Copy context files from global (`~/.config/opencode/context/`) to local (`/home/ecs-user/.config/opencode/context/`) so they're project-specific and git-committed.
...
Local location: /home/ecs-user/.config/opencode/context/
...
If local `/home/ecs-user/.config/opencode/context/project-intelligence/` already exists:
...
Will copy to:   /home/ecs-user/.config/opencode/context/project-intelligence/
...
**Actions on approval:**
1. Create `/home/ecs-user/.config/opencode/context/project-intelligence/` if it doesn't exist
...
Copied 3 files to /home/ecs-user/.config/opencode/context/project-intelligence/
...
**Permission denied:**
```
Error: Cannot write to /home/ecs-user/.config/opencode/context/project-intelligence/
...
- Context path resolution: `/home/ecs-user/.config/opencode/context/core/system/context-paths.md`
