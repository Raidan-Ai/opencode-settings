...
- Answer is in `/home/ecs-user/.config/opencode/context/` (use ContextScout instead)
...
- **External Context Management**: `/home/ecs-user/.config/opencode/context/core/workflows/external-context-management.md`
- **Task Delegation**: `/home/ecs-user/.config/opencode/context/core/workflows/task-delegation-basics.md`
