...
├── .cache/
│   ├── test-coverage.md (cached from /home/ecs-user/.config/opencode/context/)
│   ├── code-quality.md
│   └── code-review.md
...
```json
{
  ...
  "cache": {
    "test-coverage.md": {
      "source": "/home/ecs-user/.config/opencode/context/core/standards/test-coverage.md",
...
IF cache exists AND cache is valid:
  ...
  SKIP re-reading from /home/ecs-user/.config/opencode/context/
ELSE:
  READ from /home/ecs-user/.config/opencode/context/
  CACHE the file
```
