...
task(
  ...
  prompt="Context to load:
          - /home/ecs-user/.config/opencode/context/core/visual-development.md
...
- **UI Design Workflow**: `/home/ecs-user/.config/opencode/context/core/workflows/design-iteration-overview.md`
- **Design Systems**: `/home/ecs-user/.config/opencode/context/ui/web/design-systems.md`
- **UI Styling Standards**: `/home/ecs-user/.config/opencode/context/ui/web/ui-styling-standards.md`
- **Animation Patterns**: `/home/ecs-user/.config/opencode/context/ui/web/animation-basics.md`, `/home/ecs-user/.config/opencode/context/ui/web/animation-advanced.md`
- **Subagent Invocation Guide**: `/home/ecs-user/.config/opencode/context/openagents-repo/guides/subagent-invocation.md`
- **Agent Capabilities**: `/home/ecs-user/.config/opencode/context/openagents-repo/core-concepts/agents.md`
