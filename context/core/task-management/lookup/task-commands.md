...
```bash
npx ts-node /home/ecs-user/.config/opencode/context/tasks/scripts/task-cli.ts <command> [args]
```
...
See `/home/ecs-user/.config/opencode/context/core/workflows/multi-stage-orchestration.md` for the complete workflow.
