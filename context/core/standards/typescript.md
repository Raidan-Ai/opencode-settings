...
- **OpenCode TypeScript**: `/home/ecs-user/.config/opencode/context/openagents-repo/standards/opencode-typescript.md` (framework-specific patterns)
- **Code Quality**: `/home/ecs-user/.config/opencode/context/core/standards/code-quality.md` (general quality standards)
- **Test Coverage**: `/home/ecs-user/.config/opencode/context/core/standards/test-coverage.md` (testing standards)
