...
```
/home/ecs-user/.config/opencode/context/project-intelligence/
...
- `/home/ecs-user/.config/opencode/context/core/standards/project-intelligence.md` (standards and patterns)
- `/home/ecs-user/.config/opencode/context/core/system/context-guide.md` (context loading)

See `/home/ecs-user/.config/opencode/context/core/context-system.md` for the broader context architecture.
...
**Management Guide**: See `/home/ecs-user/.config/opencode/context/core/standards/project-intelligence-management.md` for complete lifecycle management including:
...
See `/home/ecs-user/.config/opencode/context/core/standards/project-intelligence.md` for the standard itself.
