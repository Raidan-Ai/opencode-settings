...
- Locate context directories (`/home/ecs-user/.config/opencode/context/`, `docs/`, `.context/`, etc.)
...
```
/home/ecs-user/.config/opencode/context/
...
```bash
list(path="/home/ecs-user/.config/opencode/context")
```
...
list(path="/home/ecs-user/.config/opencode/context/{category}")

# Read relevant files
read(filePath="/home/ecs-user/.config/opencode/context/{category}/{file}.md")
```
...
**Context Location**: `/home/ecs-user/.config/opencode/context/`
**Files Searched**: 12
...
#### ⭐⭐⭐⭐⭐ Code Standards
**Path**: `/home/ecs-user/.config/opencode/context/core/standards/code.md`
...
/home/ecs-user/.config/opencode/context/core/workflows/
└── review.md ⭐ FOUND
```
...
3. `/home/ecs-user/.config/opencode/context/core/workflows/review.md` - Code review expectations
...
### Additional Context Available
If you need more information on:
- **Code standards** → Check `/home/ecs-user/.config/opencode/context/core/standards/code.md`
- **Testing guidelines** → Check `/home/ecs-user/.config/opencode/context/core/standards/tests.md`
```

## Discovery Patterns

### Pattern 1: Well-Organized Context
Repository has clear context structure (`/home/ecs-user/.config/opencode/context/` or `docs/`)
