   ...
   <stage id="3" name="LoadContext" enforce="@context_before_execution">
     ...
     <process>
       ...
       1. Load quick-start.md for repo orientation:
          Read: /home/ecs-user/.config/opencode/context/openagents-repo/quick-start.md
    ...
    <step id="4A" name="DelegateWithSession">
      ...
      <process>
        ...
        3. Create context file at .tmp/sessions/{session_id}/context.md:
           ...
           Example:
           - /home/ecs-user/.config/opencode/context/openagents-repo/quick-start.md
           - /home/ecs-user/.config/opencode/context/openagents-repo/core-concepts/evals.md
    ...
    <process>
      1. Update affected documentation:
         ...
         IF simple doc updates (1-2 files, minor changes):
           ...
           Apply standards from /home/ecs-user/.config/opencode/context/core/standards/documentation.md
